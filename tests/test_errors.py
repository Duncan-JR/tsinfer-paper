...
class TestUnbiasedMispolarise:
    ...
    def test_singletons_are_never_mispolarised(
        self, four_allele_example, singleton_mask, rng
    ):
        variant_allele, ancestral_state = four_allele_example
        include_mispol, mispol_ancestral = errors.unbiased_mispolarise(
            variant_allele,
        ...
        assert_array_equal(include_mispol, ~singleton_mask)
        expected_ancestral = ancestral_state.copy()
        expected_ancestral[~singleton_mask] = "T"
        assert_array_equal(mispol_ancestral, expected_ancestral)
